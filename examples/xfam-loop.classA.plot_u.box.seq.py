...
# [[[ Set up the box range ]]]
## box_range = [   591, 591+20]    # TM6 ic swing
## box_range = [591+20, 591+40]    # TM6 ec
## box_range = [680, 680+14]    # TM7 ic
## box_range = [680+15, 708]    # TM7 ec
box_dict = {
    "TM6ic" : [591 +  0, 591 + 20],
    "TM6ec" : [591 + 20, 591 + 40],
    "H8"    : [722,           735],
}
box_range = box_dict["TM6ic"]
box_b, box_e = box_range
...
def plot_left_singualr_by_rank(rank):
    return plot_left_singular(u, rank, 
                                 ...
                                 intst_max =  0.01,
                                 fl_path = fl_path,
                                 fl_postfix = f'.{box_b:03d}to{box_e:03d}',
                                 box_range = box_range,
